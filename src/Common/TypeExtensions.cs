...
#endif
{
    ...
    internal static class TypeExtensions
    {
        ...
        private static readonly Lazy<Dictionary<Type, HashSet<Type>>> _implicitlyCompatibleValueTypes =
            new Lazy<Dictionary<Type, HashSet<Type>>>(
        ...
        public static bool IsValueAssignableFrom(this Type to, Type from)
        {
            ...
            if (from.IsPrimitive
                && to.IsPrimitive
                && _implicitlyCompatibleValueTypes.Value.TryGetValue(from, out targetTypes))
            {
                return targetTypes.Contains(to);
            }
