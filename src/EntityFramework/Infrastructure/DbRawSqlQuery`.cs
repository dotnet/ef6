...
namespace System.Data.Entity.Infrastructure
{
...
#endif
    {
        ...
        /// </summary>
        /// <returns>
        ///     A <see cref="Task"/> containing <c>default</c>(<typeparamref name="TElement"/>) if query result is empty;
        ...
        /// <param name="predicate"> A function to test each element for a condition. </param>
        /// <returns>
        ///     A <see cref="Task"/> containing <c>default</c>(<typeparamref name="TElement"/>)
        ///     if query result is empty or if no element passes the test specified by <paramref name="predicate"/>;
        ///     otherwise, the first element in the query result that passes the test specified by <paramref name="predicate"/>.
        /// </returns>
        /// <exception cref="ArgumentNullException"> <paramref name="predicate"/> is <c>null</c>. </exception>
        ...
        /// <param name="predicate"> A function to test each element for a condition. </param>
        /// <returns>
        ///     A <see cref="Task"/> containing the single element of the query result that satisfies the condition in <paramref name="predicate"/>.
        /// </returns>
        /// <exception cref="ArgumentNullException"> <paramref name="predicate"/> is <c>null</c>. </exception>
        ...
        /// <param name="predicate"> A function to test each element for a condition. </param>
        /// <returns>
        ///     A <see cref="Task"/> containing the single element of the query result or <c>default</c>(<typeparamref name="TElement"/>)
        ...
        /// <returns>
        ///     A <see cref="Task"/> containing <c>true</c> if the query result contains the specified value;
        ///     otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <param name="predicate"> A function to test each element for a condition. </param>
        /// <returns>
        ///     A <see cref="Task"/> containing <c>true</c> if any elements in the query result pass the test in the specified predicate;
        ///     otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <param name="predicate"> A function to test each element for a condition. </param>
        /// <returns>
        ///     A <see cref="Task"/> containing <c>true</c> if every element of the query result passes the test in the specified predicate;
        ///     otherwise, <c>false</c>.
        /// </returns>
        /// <exception cref="ArgumentNullException"> <paramref name="predicate"/> is <c>null</c>. </exception>
        ...
        ///     The number of elements in the query result is larger than <see cref="Int32.MaxValue"/>.
        /// </exception>
        ...
        /// <param name="predicate"> A function to test each element for a condition. </param>
        /// <returns>
        ///     A <see cref="Task"/> containing the number of elements in the query result that satisfies
        ...
        /// <returns> A <see cref="Task"/> containing the number of elements in the query result. </returns>
        /// <exception cref="OverflowException">
        ///     The number of elements in the query result is larger than <see cref="Int64.MaxValue"/>.
        /// </exception>
