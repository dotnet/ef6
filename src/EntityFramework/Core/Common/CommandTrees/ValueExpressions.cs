namespace System.Data.Entity.Core.Common.CommandTrees
{
    ...
    public sealed class MethodExpression : Expression
    {
            ...
            : base(cmdTree, ExpressionKind.Method)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Method_VoidResultInvalid, "methodInfo");
            }
            ...
            if (methodInfo.IsStatic)
            {
                if (instance != null)
                {
                    throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Method_InstanceInvalidForStatic, "instance");
                }
            }
            else
            {
                if (null == instance)
                {
                    throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Method_InstanceRequiredForInstance, "instance");
                }
        ...
        { 
            ...
            /*CQT_PUBLIC_API(*/internal/*)*/ set
            {
                ...
                {
                    throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.Cqt_Method_InstanceInvalidForStatic);
                }
    ...
    internal sealed class DbRelatedEntityRef
    {
        ...
        internal DbRelatedEntityRef(RelationshipEndMember sourceEnd, RelationshipEndMember targetEnd, DbExpression targetEntityRef)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_RelatedEntityRef_TargetEndFromDifferentRelationship, "targetEnd");
            }
            // 2. Not the same end
            if (object.ReferenceEquals(sourceEnd, targetEnd))
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_RelatedEntityRef_TargetEndSameAsSourceEnd, "targetEnd");
            }
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_RelatedEntityRef_TargetEndMustBeAtMostOne, "targetEnd");
            }
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_RelatedEntityRef_TargetEntityNotRef, "targetEntityRef");
            }
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_RelatedEntityRef_TargetEntityNotCompatible, "targetEntityRef");
            }
