namespace System.Data.Entity.Core.Common.CommandTrees.ExpressionBuilder.Internal
{
    ...
    internal static class ArgumentValidation
    {
        ...
        private static void RequirePolymorphicType(TypeUsage type, string typeArgumentName)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_General_PolymorphicTypeRequired(TypeHelpers.GetFullName(type)), "type");
            } 
        }
        ...
        private static void RequireCompatibleType(DbExpression expression, TypeUsage requiredResultType, string argumentName, int argumentIndex)
        {
            ...
            if (!TypeSemantics.IsStructurallyEqualOrPromotableTo(expression.ResultType, requiredResultType))
            {
                ...
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_ExpressionLink_TypeMismatch(
        ...
        private static void RequireCompatibleType(DbExpression expression, PrimitiveTypeKind requiredResultType, string argumentName, int index)
        {
                ...
                valueTypeKind != requiredResultType)
            {
                ...
                throw EntityUtil.Argument(
                    System.Data.Entity.Resources.Strings.Cqt_ExpressionLink_TypeMismatch(
                        (valueIsPrimitive ?
        ...
        private static void RequireCompatibleType(DbExpression from, RelationshipEndMember end, bool allowAllRelationshipsInSameTypeHierarchy)
        {
            ...
            if (allowAllRelationshipsInSameTypeHierarchy)
            {
                ...
                {
                    throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_RelNav_WrongSourceType(TypeHelpers.GetFullName(endType)), "from");
                }
            }
        ...
        private static void RequireCollectionArgument<TExpressionType>(DbExpression argument)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Unary_CollectionRequired(typeof(TExpressionType).Name), "argument");
            }
        }
        ...
        private static TypeUsage RequireCollectionArguments<TExpressionType>(DbExpression left, DbExpression right)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Binary_CollectionsRequired(typeof(TExpressionType).Name));
            }
        ...
        private static TypeUsage RequireComparableCollectionArguments<TExpressionType>(DbExpression left, DbExpression right)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_InvalidTypeForSetOperation(TypeHelpers.GetElementTypeUsage(left.ResultType).Identity, typeof(TExpressionType).Name), "left");
            }

            if (!TypeHelpers.IsSetComparableOpType(TypeHelpers.GetElementTypeUsage(right.ResultType)))
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_InvalidTypeForSetOperation(TypeHelpers.GetElementTypeUsage(right.ResultType).Identity, typeof(TExpressionType).Name), "right");
            }
        ...
        internal static TypeUsage ValidateBindAs(DbExpression input, string varName)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Binding_VariableNameNotValid, "varName");
            }
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Binding_CollectionRequired, "input");
            }
        ...
        internal static TypeUsage ValidateGroupBindAs(DbExpression input, string varName, string groupVarName)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_GroupBinding_GroupVariableNameNotValid, "groupVarName");
            }
            ...
            if (!TypeHelpers.TryGetCollectionElementType(input.ResultType, out elementType))
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_GroupBinding_CollectionRequired, "input");
            }
        ...
        internal static DbExpressionList ValidateFunctionAggregate(EdmFunction function, IEnumerable<DbExpression> args)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Aggregate_InvalidFunction, "function");
            }
        ...
        internal static void ValidateSortClause(DbExpression key)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Sort_OrderComparable, "key");
            }
        }
        ...
        internal static void ValidateSortClause(DbExpression key, string collation)
        {
            ...
            {
                throw EntityUtil.ArgumentOutOfRange(System.Data.Entity.Resources.Strings.Cqt_Sort_EmptyCollationInvalid, "collation");
            }

            if (!TypeSemantics.IsPrimitiveType(key.ResultType, PrimitiveTypeKind.String))
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Sort_NonStringCollationInvalid, "collation");
            }
        }
        ...
        internal static TypeUsage ValidateApply(DbExpressionBinding input, DbExpressionBinding apply)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Apply_DuplicateVariableNames);
            }
        ...
        internal static System.Collections.ObjectModel.ReadOnlyCollection<DbExpressionBinding> ValidateCrossJoin(IEnumerable<DbExpressionBinding> inputs, out TypeUsage resultType)
        {
            ...
            while (inputEnum.MoveNext())
            {
                ...
                {
                    throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_CrossJoin_DuplicateVariableNames(nameIndex, iPos, input.VariableName));
                }
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_CrossJoin_AtLeastTwoInputs, "inputs");
            }
        ...
        internal static TypeUsage ValidateJoin(DbExpressionBinding left, DbExpressionBinding right, DbExpression joinCondition)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Join_DuplicateVariableNames);
            }
        ...
        internal static TypeUsage ValidateGroupBy(DbGroupExpressionBinding input, IEnumerable<KeyValuePair<string, DbExpression>> keys, IEnumerable<KeyValuePair<string, DbAggregate>> aggregates, out DbExpressionList validKeys, out System.Collections.ObjectModel.ReadOnlyCollection<DbAggregate> validAggregates)
        {
            ...
            var keyValidator = CreateValidator(keys, "keys",
                (keyInfo, index) =>
                {
                    ...
                    {
                        throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_GroupBy_KeyNotEqualityComparable(keyInfo.Key));
                    }
            ...
            var aggValidator = CreateValidator(aggregates, "aggregates",
                (aggInfo, idx) =>
                {
                    ...
                    {
                        throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_GroupBy_AggregateColumnExistsAsGroupColumn(aggInfo.Key));
                    }
                    ...
                    if (aggInfo.Value is DbGroupAggregate)
                    {
                        ...
                        {
                            throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_GroupBy_MoreThanOneGroupAggregate);
                        }
                        else
                        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_GroupBy_AtLeastOneKeyOrAggregate);
            }
        ...
        internal static System.Collections.ObjectModel.ReadOnlyCollection<DbSortClause> ValidateSkip(DbExpressionBinding input, IEnumerable<DbSortClause> sortOrder, DbExpression count)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Skip_IntegerRequired, "count");
            }
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Skip_ConstantOrParameterRefRequired, "count");
            }
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Skip_NonNegativeCountRequired, "count");
            }
        ...
        internal static TypeUsage ValidateConstant(object value)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Constant_InvalidType, "value");
            }
        ...
        internal static void ValidateConstant(TypeUsage constantType, object value)
        {
            ...
            if(TypeHelpers.TryGetEdmType<EnumType>(constantType, out edmEnumType))
            {
                ...
                // type of the value has to match the edm enum type or underlying types have to be the same
                 ...
                 {
                    throw EntityUtil.Argument(
                        System.Data.Entity.Resources.Strings.Cqt_Constant_ClrEnumTypeDoesNotMatchEdmEnumType(
                            value.GetType().Name,
                            edmEnumType.Name,
            ...
            else
            {
                ...
                {
                    throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Constant_InvalidConstantType(constantType.ToString()), "constantType");
                }
                    ...
                    primitiveType.PrimitiveTypeKind != valueKind)
                {
                    ...
                    {
                        throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Constant_InvalidValueForType(constantType.ToString()), "value");
                    }
                }
            }
        }
        ...
        internal static void ValidateParameter(TypeUsage type, string name)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_CommandTree_InvalidParameterName(name), "name");
            }            
        }
        ...
        internal static void ValidateVariable(TypeUsage type, string name)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Binding_VariableNameNotValid, "name");
            }
        }
        ...
        internal static TypeUsage ValidateAnd(DbExpression left, DbExpression right)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_And_BooleanArgumentsRequired);
            }
        ...
        internal static TypeUsage ValidateOr(DbExpression left, DbExpression right)
        {
            ...
            if (null == resultType || !TypeSemantics.IsPrimitiveType(resultType, PrimitiveTypeKind.Boolean))
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Or_BooleanArgumentsRequired);
            }
        ...
        internal static TypeUsage ValidateNot(DbExpression argument)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Not_BooleanArgumentRequired);
            }
        ...
        internal static DbExpressionList ValidateArithmetic(DbExpression argument, out TypeUsage resultType)
        {
            ...
            if (!TypeSemantics.IsNumericType(resultType))
            {
                ...
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Arithmetic_NumericCommonType);
            }
            ...
            if (TypeSemantics.IsUnsignedNumericType(argument.ResultType))
            {
                ...
                {
                    throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Arithmetic_InvalidUnsignedTypeForUnaryMinus(argument.ResultType.EdmType.FullName));
                }
            }
            return new DbExpressionList(new[] { argument });
        }
        ...
        internal  static TypeUsage ValidateComparison(DbExpressionKind kind, DbExpression left, DbExpression right)
        {
            ...
            if (!equality || !order)
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Comparison_ComparableRequired);
            }
        ...
        internal static TypeUsage ValidateIsNull(DbExpression argument, bool allowRowType)
        {
            ...
            if (TypeSemantics.IsCollectionType(argument.ResultType))
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_IsNull_CollectionNotAllowed);
            }
            ...
            if (!TypeHelpers.IsValidIsNullOpType(argument.ResultType))
            {
                ...
                {
                    throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_IsNull_InvalidType);
                }
            }
        ...
        internal static void ValidateCastTo(DbExpression argument, TypeUsage toType)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Cast_InvalidCast(TypeHelpers.GetFullName(argument.ResultType), TypeHelpers.GetFullName(toType)));
            }
        }
        ...
        internal static void ValidateTreatAs(DbExpression argument, TypeUsage asType)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_General_PolymorphicArgRequired(typeof(DbTreatExpression).Name));
            }
        }
        ...
        internal static TypeUsage ValidateOfType(DbExpression argument, TypeUsage type)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_General_PolymorphicArgRequired(typeof(DbOfTypeExpression).Name));
            }
        ...
        internal static TypeUsage ValidateIsOf(DbExpression argument, TypeUsage type)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_General_PolymorphicArgRequired(typeof(DbIsOfExpression).Name));
            }
        ...
        internal static TypeUsage ValidateDeref(DbExpression argument)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_DeRef_RefRequired, "argument");
            }
        ...
        internal static TypeUsage ValidateGetEntityRef(DbExpression argument)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_GetEntityRef_EntityRequired, "argument");
            }
        ...
        internal static TypeUsage ValidateCreateRef(EntitySet entitySet, EntityType entityType, IEnumerable<DbExpression> keyValues, out DbExpression keyConstructor)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Ref_PolymorphicArgRequired);
            }
        ...
        internal static TypeUsage ValidateGetRefKey(DbExpression argument)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_GetRefKey_RefRequired, "argument");
            }
        ...
        internal static TypeUsage ValidateNavigate(DbExpression navigateFrom, RelationshipType type, string fromEndName, string toEndName, out RelationshipEndMember fromEnd, out RelationshipEndMember toEnd)
        {
            ...
            {
                throw EntityUtil.ArgumentOutOfRange(System.Data.Entity.Resources.Strings.Cqt_Factory_NoSuchRelationEnd, fromEndName);
            }

            if (!type.RelationshipEndMembers.TryGetValue(toEndName, false /*ignoreCase*/, out toEnd))
            {
                throw EntityUtil.ArgumentOutOfRange(System.Data.Entity.Resources.Strings.Cqt_Factory_NoSuchRelationEnd, toEndName);
            }
        ...
        internal static TypeUsage ValidateNavigate(DbExpression navigateFrom, RelationshipEndMember fromEnd, RelationshipEndMember toEnd, out RelationshipType relType, bool allowAllRelationshipsInSameTypeHierarchy)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Factory_IncompatibleRelationEnds, "toEnd");
            }
        ...
        internal static TypeUsage ValidateDistinct(DbExpression argument)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Distinct_InvalidCollection, "argument");
            }
        ...
        internal static TypeUsage ValidateLimit(DbExpression argument, DbExpression limit)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Limit_IntegerRequired, "limit");
            }
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Limit_ConstantOrParameterRefRequired, "limit");
            }
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Limit_NonNegativeLimitRequired, "limit");
            }
        ...
        internal static TypeUsage ValidateCase(IEnumerable<DbExpression> whenExpressions, IEnumerable<DbExpression> thenExpressions, DbExpression elseExpression, out DbExpressionList validWhens, out DbExpressionList validThens)
        {
            ...
            validThens = CreateExpressionList(thenExpressions, "thenExpressions", (exp, idx) =>
                {
                    ...
                    else
                    {
                        ...
                        if (null == commonResultType)
                        {
                            throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Case_InvalidResultType);
                        }
                    }
                }
            );
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Case_WhensMustEqualThens);
            }
        ...
        internal static TypeUsage ValidateFunction(EdmFunction function, IEnumerable<DbExpression> arguments, out DbExpressionList validArgs)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Function_NonComposableInExpression, "function");
            }
            if (!String.IsNullOrEmpty(function.CommandTextAttribute) && !function.HasUserDefinedBody)
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Function_CommandTextInExpression, "function");
            }
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Function_VoidResultInvalid, "function");
            }
            ...
            validElements = CreateExpressionList(elements, "elements", (exp, idx) =>
                {
                    ...
                    {
                        throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Factory_NewCollectionInvalidCommonType, "collectionElements");
                    }
                }
            );
        ...
        internal static TypeUsage ValidateNewEmptyCollection(TypeUsage collectionType, out DbExpressionList validElements)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_NewInstance_CollectionTypeRequired, "collectionType");
            }
        ...
        private static List<TypeUsage> GetStructuralMemberTypes(TypeUsage instanceType)
        {
            ...
            if (null == structType)
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_NewInstance_StructuralTypeRequired, "instanceType");
            }

            if (structType.Abstract)
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_NewInstance_CannotInstantiateAbstractType(TypeHelpers.GetFullName(instanceType)), "instanceType");
            }

            var members = TypeHelpers.GetAllStructuralMembers(structType);
            if (members == null || members.Count < 1)
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_NewInstance_CannotInstantiateMemberlessType(TypeHelpers.GetFullName(instanceType)), "instanceType");
            }
        ...
        internal static TypeUsage ValidateNewEntityWithRelationships(EntityType entityType, IEnumerable<DbExpression> attributeValues, IList<DbRelatedEntityRef> relationships, out DbExpressionList validArguments, out System.Collections.ObjectModel.ReadOnlyCollection<DbRelatedEntityRef> validRelatedRefs)
        {
            ...
            if (relationships.Count > 0)
            {
                ...
                for (int idx = 0; idx < relationships.Count; idx++)
                {
                    ...
                    {
                        throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_NewInstance_IncompatibleRelatedEntity_SourceTypeNotValid, StringUtil.FormatIndex("relationships", idx));
                    }
        ...
        internal static TypeUsage ValidateProperty(DbExpression instance, EdmMember property, string propertyArgumentName)
        {
            ...
            if (null == instance)
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Property_InstanceRequiredForInstance, "instance");
            }
        ...
        internal static TypeUsage ValidateProperty(DbExpression instance, string propertyName, bool ignoreCase, out EdmMember foundMember)
        {
            ...
            throw EntityUtil.ArgumentOutOfRange(System.Data.Entity.Resources.Strings.Cqt_Factory_NoSuchProperty(propertyName, TypeHelpers.GetFullName(instance.ResultType)), "propertyName");
        }
        ...
        private static void CheckReadOnly(GlobalItem item, string varName)
        {
            ...
            if (!(item.IsReadOnly))
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_General_MetadataNotReadOnly, varName);
            }
        }
        ...
        private static void CheckType(TypeUsage type, string varName)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Metadata_TypeUsageIncorrectSpace, "type");
            }
        }
        ...
        private static void CheckMember(EdmMember memberMeta, string varName)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Metadata_EdmMemberIncorrectSpace, varName);
            }
        }
        ...
        private static void CheckParameter(FunctionParameter paramMeta, string varName)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Metadata_FunctionParameterIncorrectSpace, varName);
            }
        }
        ...
        private static void CheckFunction(EdmFunction function)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Metadata_FunctionIncorrectSpace, "function");
            }

            // Composable functions must have a return parameter.
            if (function.IsComposableAttribute && null == function.ReturnParameter)
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Metadata_FunctionReturnParameterNull, "function");
            }
            ...
            if (function.ReturnParameter != null)
            {
                ...
                {
                    throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Metadata_FunctionParameterIncorrectSpace, "function.ReturnParameter");
                }
            }
        ...
        private static void CheckEntitySet(EntitySetBase entitySet, string varName)
        {
            ...
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Metadata_EntitySetEntityContainerNull, varName);
            }

            if(!CheckDataSpace(entitySet.EntityContainer))
            {
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Metadata_EntitySetIncorrectSpace, varName);
            }
