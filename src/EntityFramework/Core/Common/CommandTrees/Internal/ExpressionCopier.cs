    ...
    internal class DbExpressionRebinder : DefaultExpressionVisitor
    {
        ...
        protected override EntitySetBase VisitEntitySet(EntitySetBase entitySet)
        {
            ...
            if (_metadata.TryGetEntityContainer(entitySet.EntityContainer.Name, entitySet.EntityContainer.DataSpace, out container))
            {
                ...
                throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Copier_EntitySetNotFound(entitySet.EntityContainer.Name, entitySet.Name));
            }

            throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Copier_EntityContainerNotFound(entitySet.EntityContainer.Name));
        }
        ...
        protected override EdmFunction VisitFunction(EdmFunction function)
        {
            ...
            throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Copier_FunctionNotFound(TypeHelpers.GetFullName(function)));
        }
        ...
        protected override EdmType VisitType(EdmType type)
        {
            ...
            else
            {
                if (!_metadata.TryGetType(type.Name, type.NamespaceName, type.DataSpace, out retType) ||
                    null == retType)
                {
                    throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Copier_TypeNotFound(TypeHelpers.GetFullName(type)));
                }
            }
        ...
        public override DbExpression Visit(DbPropertyExpression expression)
        {
            ...
            if (!object.ReferenceEquals(expression.Instance, newInstance))
            {
                if (Helper.IsRelationshipEndMember(expression.Property))
                {
                    ...
                    {
                        throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Copier_EndNotFound(expression.Property.Name, TypeHelpers.GetFullName(newInstance.ResultType.EdmType)));
                    }
                ...
                else if (Helper.IsNavigationProperty(expression.Property))
                {
                    ...
                    {
                        throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Copier_NavPropertyNotFound(expression.Property.Name, TypeHelpers.GetFullName(newInstance.ResultType.EdmType)));
                    }
                ...
                else
                {
                    ...
                    {
                        throw EntityUtil.Argument(System.Data.Entity.Resources.Strings.Cqt_Copier_PropertyNotFound(expression.Property.Name, TypeHelpers.GetFullName(newInstance.ResultType.EdmType)));
                    }
