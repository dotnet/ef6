...
namespace System.Data.Entity.Core.Common.CommandTrees.Internal
{
    ...
    internal static class Patterns
    {
        ...
        /// <summary>
        ///     Constructs a new pattern that is matched iff both <paramref name="pattern1" /> and <paramref name="pattern2" /> are matched. Does NOT return a pattern that matches <see
        ///      cref="DbAndExpression" />. Use <see cref="MatchKind" /> with an argument of <see cref="DbExpressionKind.And" /> to match an AND expression
        /// </summary>
        ...
        /// <summary>
        ///     Constructs a new pattern that is matched iff all of <paramref name="pattern1" />, <paramref name="pattern2" /> and <paramref
        ///      name="pattern3" /> are matched. Does NOT return a pattern that matches <see cref="DbAndExpression" />. Use <see
        ///      cref="MatchKind" /> with an argument of <see cref="DbExpressionKind.And" /> to match an AND expression
        /// </summary>
        ...
        /// <summary>
        ///     Constructs a new pattern that is matched if either <paramref name="pattern1" /> or <paramref name="pattern2" /> are matched. Does NOT return a pattern that matches <see
        ///      cref="DbOrExpression" />. Use <see cref="MatchKind" /> with an argument of <see cref="DbExpressionKind.Or" /> to match an OR expression
        /// </summary>
        ...
        /// <summary>
        ///     Constructs a new pattern that is matched if either <paramref name="pattern1" />, <paramref name="pattern2" /> or <paramref
        ///      name="pattern3" /> are matched. Does NOT return a pattern that matches <see cref="DbOrExpression" />. Use <see
        ///      cref="MatchKind" /> with an argument of <see cref="DbExpressionKind.Or" /> to match an OR expression
        /// </summary>
    ...
    /// </summary>
        ...
        /// <summary>
        ///     Constructs a new pattern that is matched iff the argument expression is a <see cref="DbFilterExpression" /> with input and predicate subexpressions that match the corresponding <paramref
        ///      name="inputPattern" /> and <paramref name="predicatePattern" /> patterns
        /// </summary>
        ...
        /// <summary>
        ///     Constructs a new pattern that is matched iff the argument expression is a <see cref="DbProjectExpression" /> with input and projection subexpressions that match the corresponding <paramref
        ///      name="inputPattern" /> and <paramref name="projectionPattern" /> patterns
        /// </summary>
        ...
        /// <summary>
        ///     Constructs a new pattern that is matched iff the argument expression is a <see cref="DbCaseExpression" /> with 'when' and 'then' subexpression lists that match the specified <paramref
        ///      name="whenPattern" /> and <paramref name="thenPattern" /> collection patterns and an 'else' subexpression that matches the specified <paramref
        ///      name="elsePattern" /> expression pattern
        /// </summary>
        ...
        /// <summary>
        ///     Gets a pattern that is matched if the argument expression is a <see cref="DbCaseExpression" />. This property can be used instead of repeated calls to <see
        ///      cref="MatchKind" /> with an argument of <see cref="DbExpressionKind.Case" />
        /// </summary>
