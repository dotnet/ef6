...
namespace System.Data.Entity.Core.Mapping.ViewGeneration
{
    ...
    internal sealed class CqlGenerator : InternalBase
    {
        ...
        ///      cref="m_caseStatements" />) and returns the resulting tree.
        ...
        /// <summary>
        ///     Given the <paramref name="viewBlock" /> tree generated by the cell merging process and the <paramref
        ...
        /// <summary>
        ///     Returns an array of size <see cref="TotalSlots" /> which indicates the slots that are needed to constuct value at <paramref
        ///      name="caseMemberPath" />,
