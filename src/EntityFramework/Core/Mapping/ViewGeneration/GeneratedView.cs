namespace System.Data.Entity.Core.Mapping.ViewGeneration
{
    ...
    internal sealed class GeneratedView : InternalBase
    {
                                                       ...
                                                       out GeneratedView generatedView)
        {
            ...
            {
                EdmSchemaError error = new EdmSchemaError(System.Data.Entity.Resources.Strings.Mapping_Invalid_QueryView2(setMapping.Set.Name, parserException.Message),
            ...
            else
            {
                ...
                {
                    EdmSchemaError error = new EdmSchemaError(System.Data.Entity.Resources.Strings.Mapping_Invalid_QueryView_Type(setMapping.Set.Name),
        ...
        internal DbQueryCommandTree GetCommandTree()
        {
            if (m_commandTree == null)
            {
                ...
                {
                    throw new MappingException(System.Data.Entity.Resources.Strings.Mapping_Invalid_QueryView(m_extent.Name, parserException.Message));
                }
            }
            return m_commandTree;
        }
