...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
    ...
    internal class ExtentPair
    {
        ...
        private readonly md.EntitySetBase m_left;
        private readonly md.EntitySetBase m_right;
    ...
    internal class ForeignKeyConstraint
    {
        ...
        {
            var assocSet = relationshipSet as md.AssociationSet;
            var fromEnd = constraint.FromRole as md.AssociationEndMember;
            var toEnd = constraint.ToRole as md.AssociationEndMember;
        ...
        private readonly md.ReferentialConstraint m_constraint;
