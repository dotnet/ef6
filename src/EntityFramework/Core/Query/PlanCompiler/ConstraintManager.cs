...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
    ...
    internal class ForeignKeyConstraint
    {
        ...
        internal ForeignKeyConstraint(md.RelationshipSet relationshipSet, md.ReferentialConstraint constraint)
        {
            ...
            md.EntitySet parent = System.Data.Entity.Core.Common.Utils.MetadataHelper.GetEntitySetAtEnd(assocSet, fromEnd);// relationshipSet.GetRelationshipEndExtent(constraint.FromRole);
            md.EntitySet child = System.Data.Entity.Core.Common.Utils.MetadataHelper.GetEntitySetAtEnd(assocSet, toEnd);// relationshipSet.GetRelationshipEndExtent(constraint.ToRole);
