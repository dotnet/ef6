        ...
        private sealed partial class MethodCallTranslator : TypedTranslator<MethodCallExpression>
        {
            ...
            private sealed class DefaultTranslator : CallTranslator
            {
                ...
                internal override CqtExpression Translate(ExpressionConverter parent, MethodCallExpression call)
                {
                    ...
                    {
                        throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.ELinq_UnsupportedMethodSuggestedAlternative(call.Method, suggestedMethodInfo));
                    }
                    //The default error message
                    throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.ELinq_UnsupportedMethod(call.Method));
                }
            ...
            private sealed class FunctionCallTranslator
            {
                ...
                internal DbExpression TranslateFunctionCall(ExpressionConverter parent, MethodCallExpression call, EdmFunctionAttribute functionAttribute)
                {
                    ...
                    {
                        throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.CannotCallNoncomposableFunction(function.FullName));
                    }
                ...
                private DbExpression ValidateReturnType(DbExpression result, TypeUsage actualReturnType, ExpressionConverter parent, MethodCallExpression call, Type clrReturnType, bool isElementOfCollection)
                {
                    ...
                    switch (modelType)
                    {
                        case BuiltInTypeKind.CollectionType:
                        {
                            ...
                            {
                                throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.ELinq_EdmFunctionAttributedFunctionWithWrongReturnType(call.Method, call.Method.DeclaringType));
                            }
                ...
                internal static void ValidateFunctionAttributeParameter(MethodCallExpression call, string parameterValue, string parameterName)
                {
                    ...
                    {
                        throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.ELinq_EdmFunctionAttributeParameterNameNotValid(call.Method, call.Method.DeclaringType, parameterName));
                    }
                }
            }
                ...
                internal override CqtExpression Translate(ExpressionConverter parent, MethodCallExpression call)
                {
                    ...
                    switch (argument.ExpressionKind)
                    {
                        ...
                        case DbExpressionKind.Null:
                            ...
                            break;
                        default:
                            throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.ELinq_UnsupportedAsUnicodeAndAsNonUnicode(call.Method));
                    }
            ...
            private sealed class RemoveTranslator : CallTranslator
            {
                ...
                internal override CqtExpression Translate(ExpressionConverter parent, MethodCallExpression call)
                {
                    ...
                    if (call.Arguments.Count == 2)
                    {
                        ...
                        {
                            throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.ELinq_UnsupportedStringRemoveCase(call.Method, call.Method.GetParameters()[1].Name));
                        }
            ...
            private abstract class TrimBaseTranslator : CallTranslator
            {
                ...
                internal override CqtExpression Translate(ExpressionConverter parent, MethodCallExpression call)
                {
                    ...
                    {
                        throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.ELinq_UnsupportedTrimStartTrimEndCase(call.Method));
                    }
            ...
            private sealed class VBDatePartTranslator : CallTranslator
            {
                ...
                internal override CqtExpression Translate(ExpressionConverter parent, MethodCallExpression call)
                {
                    ...
                    {
                        throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.ELinq_UnsupportedVBDatePartNonConstantInterval(call.Method, call.Method.GetParameters()[0].Name));
                    }

                    string intervalValue = intervalLinqExpression.Value.ToString();
                    if (!s_supportedIntervals.Contains(intervalValue))
                    {
                        throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.ELinq_UnsupportedVBDatePartInvalidInterval(call.Method, call.Method.GetParameters()[0].Name, intervalValue));
                    }
            ...
            private sealed class JoinTranslator : SequenceMethodTranslator
            {
                ...
                internal override CqtExpression Translate(ExpressionConverter parent, MethodCallExpression call)
                {
                    ...
                    {
                        throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.ELinq_UnsupportedKeySelector(call.Method.Name));
                    }
            ...
            private sealed class PassthroughTranslator : UnarySequenceMethodTranslator
            {
                ...
                protected override CqtExpression TranslateUnary(ExpressionConverter parent, CqtExpression operand, MethodCallExpression call)
                {
                    ...
                    {
                        throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.ELinq_UnsupportedPassthrough(
            ...
            private sealed class OfTypeTranslator : UnarySequenceMethodTranslator
            {
                    ...
                    MethodCallExpression call)
                {
                    ...
                    {
                        throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.ELinq_InvalidOfTypeResult(DescribeClrType(clrType)));
                    }
            ...
            private sealed class ContainsTranslator : SequenceMethodTranslator
            {
                ...
                private static DbExpression TranslateContainsHelper(ExpressionConverter parent, CqtExpression left, IEnumerable<DbExpression> rightList, EqualsPattern pattern, Type leftType, Type rightType)
                {
                    ...
                    var cqt = System.Data.Entity.Core.Common.Utils.Helpers.BuildBalancedTreeInPlace(expressions,
            ...
            private sealed class FirstTranslator : FirstTranslatorBase
            {
                ...
                protected override CqtExpression TranslateUnary(ExpressionConverter parent, CqtExpression operand, MethodCallExpression call)
                {
                    if (!parent.IsQueryRoot(call))
                    {
                        throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.ELinq_UnsupportedNestedFirst);
                    }
            ...
            private abstract class SingleTranslatorBase : FirstTranslatorBase
            {
                ...
                protected override CqtExpression TranslateUnary(ExpressionConverter parent, CqtExpression operand, MethodCallExpression call)
                {
                    if (!parent.IsQueryRoot(call))
                    {
                        throw EntityUtil.NotSupported(System.Data.Entity.Resources.Strings.ELinq_UnsupportedNestedSingle);
                    }
                    return base.TranslateUnary(parent, operand, call);
                }
            ...
            private abstract class ThenByTranslatorBase : SequenceMethodTranslator
            {
                ...
                internal override CqtExpression Translate(ExpressionConverter parent, MethodCallExpression call)
                {
                    ...
                    {
                        throw EntityUtil.InvalidOperation(System.Data.Entity.Resources.Strings.ELinq_ThenByDoesNotFollowOrderBy);
                    }
