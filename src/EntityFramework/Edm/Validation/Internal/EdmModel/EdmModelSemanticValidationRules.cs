namespace System.Data.Entity.Edm.Validation.Internal.EdmModel
{
    ...
    internal static class EdmModelSemanticValidationRules
    {
                ...
                (context, edmEntityContainer) =>
                    {
                        ...
                        foreach (var set in edmEntityContainer.AssociationSets)
                        {
                            ...
                            var existSourceEnd =
                                sourceEndList.FirstOrDefault(e => DataModelValidationHelper.AreRelationshipEndsEqual(e, sourceEnd));
                            var existTargetEnd =
                                targetEndList.FirstOrDefault(e => DataModelValidationHelper.AreRelationshipEndsEqual(e, targetEnd));
        ...
        internal static readonly EdmModelValidationRule<EdmEntityContainer> EdmEntityContainer_InvalidEntitySetNameReference =
            new EdmModelValidationRule<EdmEntityContainer>(
                (context, edmEntityContainer) =>
                    {
                                    ...
                                    if (!edmEntityContainer.EntitySets.Contains(associationSet.SourceSet))
                                    {
                                        context.AddError(
                                            ...
                                            Strings.EdmModel_Validator_Semantic_InvalidEntitySetNameReference(
                                                associationSet.SourceSet.Name, associationSet.ElementType.SourceEnd.Name),
                                    ...
                                    && associationSet.ElementType.TargetEnd != null)
                                {
                                    if (!edmEntityContainer.EntitySets.Contains(associationSet.TargetSet))
                                    {
                                        context.AddError(
                                            ...
                                            null,
                                            Strings.EdmModel_Validator_Semantic_InvalidEntitySetNameReference(
                                                associationSet.TargetSet.Name, associationSet.ElementType.TargetEnd.Name),
                                            XmlErrorCode.InvalidEndEntitySet);
                                    }
                                }
                            }
        ...
        internal static readonly EdmModelValidationRule<EdmEntityContainer> EdmEntityContainer_ConcurrencyRedefinedOnSubTypeOfEntitySetType
            =
            new EdmModelValidationRule<EdmEntityContainer>(
                (context, edmEntityContainer) =>
                    {
                                ...
                                DataModelValidationHelper.IsTypeDefinesNewConcurrencyProperties(entityType))
                            {
                                context.AddError(
                                    ...
                                    Strings.EdmModel_Validator_Semantic_ConcurrencyRedefinedOnSubTypeOfEntitySetType(
                                        ...
                                        set.ElementType.GetQualifiedName(context.GetQualifiedPrefix(set.ElementType)),
        ...
        internal static readonly EdmModelValidationRule<EdmEntityContainer> EdmEntityContainer_DuplicateEntityContainerMemberName =
            new EdmModelValidationRule<EdmEntityContainer>(
                (context, edmEntityContainer) =>
                    {
                ...
                (context, edmAssociationSet) =>
                    {
                        ...
                        {
                            if (edmAssociationSet.ElementType.SourceEnd.Name == edmAssociationSet.ElementType.TargetEnd.Name)
                            {
                                context.AddError(
                                    edmAssociationSet.SourceSet,
                                    CsdlConstants.Attribute_Name,
                                    Strings.EdmModel_Validator_Semantic_DuplicateEndName(edmAssociationSet.ElementType.SourceEnd.Name),
        ...
        internal static readonly EdmModelValidationRule<EdmEntityType> EdmEntityType_DuplicatePropertyNameSpecifiedInEntityKey =
                            ...
                            if (key.PropertyType.IsPrimitiveType)
                            {
                                    ...
                                    key.PropertyType.IsNullable.Value)
                                {
                                    context.AddError(
                                        ...
                                        Strings.EdmModel_Validator_Semantic_InvalidKeyNullablePart(key.Name, edmEntityType.Name),
                        ...
                        foreach (var key in edmEntityType.GetValidKey())
                        {
                            if (!key.PropertyType.IsUnderlyingPrimitiveType)
                            {
                                context.AddError(
                                    key,
                                    null,
                                    Strings.EdmModel_Validator_Semantic_EntityKeyMustBeScalar(edmEntityType.Name, key.Name),
                ...
                (context, edmEntityType) =>
                    {
                        ...
                        if (edmEntityType.Name.HasContent() && properties.Count > 0)
                        {
                                    ...
                                    if (property.Name.EqualsOrdinal(edmEntityType.Name))
                                    {
                                        context.AddError(
                                            ...
                                            Strings.EdmModel_Validator_Semantic_InvalidMemberNameMatchesTypeName(
                                                property.Name, edmEntityType.GetQualifiedName(context.GetQualifiedPrefix(edmEntityType))),
                            ...
                            if (property != null)
                            {
                                if (property.Name.HasContent())
                                {
                                    DataModelValidationHelper.AddMemberNameToHashSet(
                                        ...
                                        propertyNames,
                                        context,
                                        (name) => Strings.EdmModel_Validator_Semantic_PropertyNameAlreadyDefinedDuplicate(name));
                                }
                            }
                        }
        ...
        internal static readonly EdmModelValidationRule<EdmNavigationProperty> EdmNavigationProperty_BadNavigationPropertyUndefinedRole =
                    ...
                    (context, edmNavigationProperty) =>
                        {
                            if (edmNavigationProperty.Association != null &&
                                ...
                                edmNavigationProperty.Association.TargetEnd != null)
                            {
                                if (edmNavigationProperty.ResultEnd == edmNavigationProperty.GetFromEnd())
                                {
                                    context.AddError(
                                        edmNavigationProperty,
        ...
        internal static readonly EdmModelValidationRule<EdmAssociationType> EdmAssociationType_InvalidOperationMultipleEndsInAssociation =
            new EdmModelValidationRule<EdmAssociationType>(
                (context, edmAssociationType) =>
                    {
                        if ((edmAssociationType.SourceEnd != null && edmAssociationType.SourceEnd.DeleteAction.HasValue
                             && edmAssociationType.SourceEnd.DeleteAction.Value != EdmOperationAction.None) &&
                            (edmAssociationType.TargetEnd != null && edmAssociationType.TargetEnd.DeleteAction.HasValue
        ...
        internal static readonly EdmModelValidationRule<EdmAssociationType> EdmAssociationType_EndNameAlreadyDefinedDuplicate =
            new EdmModelValidationRule<EdmAssociationType>(
                (context, edmAssociationType) =>
                    {
                        if (edmAssociationType.SourceEnd != null && edmAssociationType.TargetEnd != null)
                        {
                            if (edmAssociationType.SourceEnd.Name == edmAssociationType.TargetEnd.Name)
                            {
                                context.AddError(
                                    edmAssociationType.SourceEnd,
                                    CsdlConstants.Attribute_Name,
                                    Strings.EdmModel_Validator_Semantic_EndNameAlreadyDefinedDuplicate(edmAssociationType.SourceEnd.Name),
                                    XmlErrorCode.AlreadyDefined);
                            }
                        }
                    });

        internal static readonly EdmModelValidationRule<EdmAssociationType> EdmAssociationType_SameRoleReferredInReferentialConstraint =
            new EdmModelValidationRule<EdmAssociationType>(
                (context, edmAssociationType) =>
                    {
                        if (DataModelValidationHelper.IsReferentialConstraintReadyForValidation(edmAssociationType))
                        {
                                ...
                                edmAssociationType.Constraint.DependentEnd.Name)
                            {
                                context.AddError(
                                    ...
                                    null,
                                    Strings.EdmModel_Validator_Semantic_SameRoleReferredInReferentialConstraint(edmAssociationType.Name),
                                    XmlErrorCode.SameRoleReferredInReferentialConstraint);
                            }
                        }
                    });

        internal static readonly EdmModelValidationRule<EdmAssociationType> EdmAssociationType_ValidateReferentialConstraint =
            new EdmModelValidationRule<EdmAssociationType>(
                (context, edmAssociationType) =>
                    {
                        if (DataModelValidationHelper.IsReferentialConstraintReadyForValidation(edmAssociationType))
                        {
                            ...
                            Contract.Assert(
                                constraint.DependentProperties.Count() != 0, "There should be some ref properties in Dependent Role");
                            Contract.Assert(
                            ...
                            // for v2+
                            if (principalRoleEnd.EndKind == EdmAssociationEndKind.Many)
                            {
                                context.AddError(
                                    principalRoleEnd,
                                    null,
                                ...
                                (!edmAssociationType.IsForeignKey(context.ValidationContextVersion)))
                            {
                                context.AddError(
                                    ...
                                    Strings.EdmModel_Validator_Semantic_InvalidToPropertyInRelationshipConstraint(
                                        ...
                                        edmAssociationType.GetQualifiedName(context.GetQualifiedPrefix(edmAssociationType))),
                            ...
                            {
                                if (dependentRoleEnd.EndKind == EdmAssociationEndKind.Many)
                                {
                                    context.AddError(
                                        dependentRoleEnd,
                                        null,
                            ...
                            else if (dependentRoleEnd.EndKind != EdmAssociationEndKind.Many)
                            {
                                context.AddError(
                                    dependentRoleEnd,
                                    null,
                            ...
                            if (dependentProperties.Count != keyProperties_PrincipalRoleEnd.Count)
                            {
                                context.AddError(
                                    constraint,
                                    null,
                            ...
                            else
                            {
                                ...
                                for (var i = 0; i < count; i++)
                                {
                                    ...
                                    if (principalProperty != null && dependentProperty != null &&
                                        principalProperty.PropertyType != null && dependentProperty.PropertyType != null &&
                                        principalProperty.PropertyType.IsPrimitiveType && dependentProperty.PropertyType.IsPrimitiveType)
                                    {
        ...
        internal static readonly EdmModelValidationRule<EdmAssociationType> EdmAssociationType_InvalidPropertyInRelationshipConstraint =
            new EdmModelValidationRule<EdmAssociationType>(
                (context, edmAssociationType) =>
                    {
                        ...
                        {
                            var dependentEndProperties = edmAssociationType.Constraint.DependentEnd.EntityType.Properties.ToList();
                                ...
                                if (property != null)
                                {
                                    if (property.Name.EqualsOrdinal(edmComplexType.Name))
                                    {
                                        context.AddError(
                                            ...
                                            CsdlConstants.Attribute_Name,
                                            Strings.EdmModel_Validator_Semantic_InvalidMemberNameMatchesTypeName(
                                                property.Name, edmComplexType.GetQualifiedName(context.GetQualifiedPrefix(edmComplexType))),
                                            XmlErrorCode.BadProperty);
                                    }
                                }
                            }
        ...
        internal static readonly EdmModelValidationRule<EdmComplexType> EdmComplexType_PropertyNameAlreadyDefinedDuplicate =
            new EdmModelValidationRule<EdmComplexType>(
                (context, edmComplexType) =>
                    {
        ...
        internal static readonly EdmModelValidationRule<EdmComplexType> EdmComplexType_PropertyNameAlreadyDefinedDuplicate_V1_1 =
            new EdmModelValidationRule<EdmComplexType>(
                (context, edmComplexType) =>
                    {
                        if (edmComplexType.HasDeclaredProperties)
        ...
        internal static readonly EdmModelValidationRule<EdmFunctionImport> EdmFunctionImport_FunctionImportUnknownEntitySet =
            new EdmModelValidationRule<EdmFunctionImport>(
                (context, edmFunctionImport) =>
                {
                    if (edmFunctionImport.EntitySet != null)
                    {
                        if (edmFunctionImport.EntitySet.Name.HasContent() && edmFunctionImport.Name.HasContent())
                        {
                            if (!context.ModelParentMap.GetEntityContainer(edmFunctionImport).EntitySets.Any(es => es == edmFunctionImport.EntitySet))
                            {
                                context.AddError(
                                    edmFunctionImport,
                                    CsdlConstants.Attribute_EntitySet,
                                    Strings.EdmModel_Validator_Semantic_FunctionImportUnknownEntitySet(edmFunctionImport.EntitySet.Name, edmFunctionImport.Name),
                                    XmlErrorCode.FunctionImportUnknownEntitySet);
                            }
                        }
                    }
                }
        ...
        internal static readonly EdmModelValidationRule<EdmFunctionImport> EdmFunctionImport_ComposableFunctionWithoutReturnType =
            new EdmModelValidationRule<EdmFunctionImport>(
                (context, edmFunctionImport) =>
                {
                    if (edmFunctionImport.IsComposable && edmFunctionImport.ReturnType == null)
                    {
                        context.AddError(
                            edmFunctionImport,
                            CsdlConstants.Attribute_ReturnType,
                            Strings.EdmModel_Validator_Semantic_ComposableFunctionMustDeclareReturnType,
                            XmlErrorCode.ComposableFunctionWithoutReturnType);
                    }
                }
                );

        internal static readonly EdmModelValidationRule<EdmFunctionImport> EdmFunctionImport_NonComposableFunctionMustNotDeclareReturnType =
            new EdmModelValidationRule<EdmFunctionImport>(
                (context, edmFunctionImport) =>
                {
                    if (!edmFunctionImport.IsComposable && edmFunctionImport.ReturnType != null)
                    {
                        context.AddError(
                            edmFunctionImport,
                            CsdlConstants.Attribute_ReturnType,
                            Strings.EdmModel_Validator_Semantic_NonComposableFunctionMustNotDeclareReturnType,
                            XmlErrorCode.NonComposableFunctionWithReturnType);
                    }
                }
                );

        internal static readonly EdmModelValidationRule<EdmFunctionImport> EdmFunctionImport_FunctionImportUnsupportedReturnType_V1 =
            new EdmModelValidationRule<EdmFunctionImport>(
                (context, edmFunctionImport) =>
                {
                    if (edmFunctionImport.ReturnType != null && edmFunctionImport.Name.HasContent())
                    {
                        var type = edmFunctionImport.ReturnType;
                        bool isMeetRequirement = (type.IsCollectionType &&
                                                  (type.EdmType.IsPrimitiveType || type.EdmType.IsEntityType));
                        ...
                        if (!isMeetRequirement)
                        {
                            context.AddError(
                                edmFunctionImport,
                                CsdlConstants.Attribute_ReturnType,
                                Strings.EdmModel_Validator_Semantic_FunctionImportWithUnsupportedReturnTypeV1(edmFunctionImport.Name),
                                XmlErrorCode.FunctionImportUnsupportedReturnType);
                        }
                    }
                }
                );

        internal static readonly EdmModelValidationRule<EdmFunctionImport> EdmFunctionImport_FunctionImportUnsupportedReturnType_V1_1 =
            new EdmModelValidationRule<EdmFunctionImport>(
                (context, edmFunctionImport) =>
                {
                    if (edmFunctionImport.ReturnType != null && edmFunctionImport.Name.HasContent())
                    {
                        var type = edmFunctionImport.ReturnType;
                        bool isMeetRequirement = false;

                        if (type.IsCollectionType)
                        {
                            isMeetRequirement = (type.EdmType.IsPrimitiveType || type.EdmType.IsEntityType || type.EdmType.IsComplexType);
                        }
                        else
                        {
                            isMeetRequirement = (type.IsPrimitiveType || type.IsEntityType || type.IsComplexType);
                        }
                        ...
                        if (!isMeetRequirement)
                        {
                            context.AddError(
                                edmFunctionImport,
                                CsdlConstants.Attribute_ReturnType,
                                Strings.EdmModel_Validator_Semantic_FunctionImportWithUnsupportedReturnTypeV1_1(edmFunctionImport.Name),
                                XmlErrorCode.FunctionImportUnsupportedReturnType);
                        }
                    }
                }
        ...
        internal static readonly EdmModelValidationRule<EdmFunctionImport> EdmFunctionImport_FunctionImportUnsupportedReturnType_V2 =
            new EdmModelValidationRule<EdmFunctionImport>(
                (context, edmFunctionImport) =>
                {
                    if (edmFunctionImport.ReturnType != null && edmFunctionImport.Name.HasContent())
                    {
                        var type = edmFunctionImport.ReturnType;
                        bool isMeetRequirement = type.IsCollectionType && (type.EdmType.IsPrimitiveType || type.EdmType.IsEntityType || type.EdmType.IsComplexType);
                        ...
                        if (!isMeetRequirement)
                        {
                            context.AddError(
                                edmFunctionImport,
                                CsdlConstants.Attribute_ReturnType,
                                Strings.EdmModel_Validator_Semantic_FunctionImportWithUnsupportedReturnTypeV2(edmFunctionImport.Name),
                                XmlErrorCode.FunctionImportUnsupportedReturnType);
                        }
                    }
                }
        ...
        internal static readonly EdmModelValidationRule<EdmFunctionImport> EdmFunctionImport_FunctionImportReturnEntitiesButDoesNotSpecifyEntitySet =
            new EdmModelValidationRule<EdmFunctionImport>(
                (context, edmFunctionImport) =>
                {
                    if (edmFunctionImport.ReturnType != null &&
                        edmFunctionImport.ReturnType.IsCollectionType &&
                        edmFunctionImport.ReturnType.EdmType.IsEntityType &&
                        edmFunctionImport.EntitySet == null &&
                        edmFunctionImport.Name.HasContent())
                    {
                        context.AddError(
                            edmFunctionImport,
                            CsdlConstants.Attribute_ReturnType,
                            Strings.EdmModel_Validator_Semantic_FunctionImportReturnEntitiesButDoesNotSpecifyEntitySet(edmFunctionImport.Name),
                            XmlErrorCode.FunctionImportReturnsEntitiesButDoesNotSpecifyEntitySet);
                    }
                }
                );

        internal static readonly EdmModelValidationRule<EdmFunctionImport> EdmFunctionImport_FunctionImportEntityTypeDoesNotMatchEntitySet =
            new EdmModelValidationRule<EdmFunctionImport>(
                (context, edmFunctionImport) =>
                {
                    if (edmFunctionImport.ReturnType != null &&
                        edmFunctionImport.ReturnType.IsCollectionType &&
                        edmFunctionImport.ReturnType.CollectionElementType.IsEntityType &&
                        edmFunctionImport.EntitySet != null &&
                        edmFunctionImport.EntitySet.Name.HasContent() &&
                        edmFunctionImport.Name.HasContent())
                    {
                        EdmEntitySet entitySet = context.ModelParentMap.ContainerItems.FirstOrDefault(i => i.Name == edmFunctionImport.EntitySet.Name) as EdmEntitySet;
                        if (entitySet != null && entitySet.ElementType != null)
                        {
                            if (!edmFunctionImport.ReturnType.CollectionElementType.EntityType.IsOfType(entitySet.ElementType))
                            {
                                context.AddError(
                                    edmFunctionImport,
                                    CsdlConstants.Attribute_ReturnType,
                                    Strings.EdmModel_Validator_Semantic_FunctionImportEntityTypeDoesNotMatchEntitySet(
                                        edmFunctionImport.GetQualifiedName(context.GetQualifiedPrefix(edmFunctionImport)),
                                        entitySet.ElementType.GetQualifiedName(context.GetQualifiedPrefix(entitySet.ElementType)),
                                        entitySet.Name,
                                        context.ModelParentMap.GetEntityContainer(entitySet).Name),
                                    XmlErrorCode.FunctionImportEntityTypeDoesNotMatchEntitySet);
                            }
                        }
                    }
                }
        ...
        internal static readonly EdmModelValidationRule<EdmFunctionImport> EdmFunctionImport_ComplexTypeAsReturnTypeAndDefinedEntitySet =
            new EdmModelValidationRule<EdmFunctionImport>(
                (context, edmFunctionImport) =>
                {
                    if (edmFunctionImport.ReturnType != null &&
                        edmFunctionImport.ReturnType.IsCollectionType &&
                        edmFunctionImport.ReturnType.CollectionElementType.IsComplexType &&
                        edmFunctionImport.ReturnType.CollectionElementType.EdmType.Name.HasContent() &&
                        edmFunctionImport.EntitySet != null &&
                        edmFunctionImport.EntitySet.Name.HasContent() &&
                        edmFunctionImport.Name.HasContent())
                    {
                        context.AddError(
                            edmFunctionImport,
                            CsdlConstants.Attribute_ReturnType,
                            Strings.EdmModel_Validator_Semantic_ComplexTypeAsReturnTypeAndDefinedEntitySet(
                                edmFunctionImport.GetQualifiedName(context.GetQualifiedPrefix(edmFunctionImport)),
                                edmFunctionImport.ReturnType.EdmType.Name,
                                edmFunctionImport.EntitySet.Name),
                            XmlErrorCode.ComplexTypeAsReturnTypeAndDefinedEntitySet);
                    }
                }
                );

        internal static readonly EdmModelValidationRule<EdmFunctionImport> EdmFunctionImport_FunctionImportSpecifiesEntitySetButDoesNotReturnEntityType =
            new EdmModelValidationRule<EdmFunctionImport>(
                (context, edmFunctionImport) =>
                {
                    if (edmFunctionImport.ReturnType != null &&
                        edmFunctionImport.ReturnType.IsCollectionType &&
                        edmFunctionImport.ReturnType.EdmType.IsPrimitiveType &&
                        edmFunctionImport.EntitySet != null &&
                        edmFunctionImport.EntitySet.Name.HasContent() &&
                        context.ModelParentMap.GetEntityContainer(edmFunctionImport).Name.HasContent() &&
                        edmFunctionImport.Name.HasContent())
                    {
                        context.AddError(
                            edmFunctionImport,
                            CsdlConstants.Attribute_ReturnType,
                            Strings.EdmModel_Validator_Semantic_FunctionImportSpecifiesEntitySetButNotEntityType(
                                edmFunctionImport.GetQualifiedName(context.GetQualifiedPrefix(edmFunctionImport)),
                                context.ModelParentMap.GetEntityContainer(edmFunctionImport).Name),
                            XmlErrorCode.FunctionImportSpecifiesEntitySetButDoesNotReturnEntityType);
                    }
                }
                );

        internal static readonly EdmModelValidationRule<EdmFunctionImport> EdmFunctionImport_ParameterNameAlreadyDefinedDuplicate =
            new EdmModelValidationRule<EdmFunctionImport>(
                (context, edmFunctionImport) =>
                {
                    HashSet<string> parameterList = new HashSet<string>();
                    if (edmFunctionImport.Parameters != null)
                    {
                        foreach (var parameter in edmFunctionImport.Parameters)
                        {
                            if (parameter.Name.HasContent())
                            {
                                if (!parameterList.Add(parameter.Name))
                                {
                                    context.AddError(
                                        parameter,
                                        CsdlConstants.Attribute_Name,
                                        Strings.EdmModel_Validator_Semantic_ParameterNameAlreadyDefinedDuplicate(
                                            parameter.Name),
                                        XmlErrorCode.AlreadyDefined);
                                }
                            }
        ...
        #region EdmFunction
        internal static readonly EdmModelValidationRule<EdmFunctionOverload> EdmFunction_ParameterNameAlreadyDefinedDuplicate =
            new EdmModelValidationRule<EdmFunctionOverload>(
                (context, edmFunction) =>
                {
                    HashSet<string> parameterList = new HashSet<string>();
