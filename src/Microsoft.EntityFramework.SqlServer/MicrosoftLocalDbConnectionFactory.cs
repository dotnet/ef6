...
namespace System.Data.Entity.Infrastructure
{
    ...
    /// </remarks>
    public sealed class MicrosoftLocalDbConnectionFactory : IDbConnectionFactory
    {
        ...
        /// </summary>
        public MicrosoftLocalDbConnectionFactory()
            : this("mssqllocaldb")
        {
        }
        ...
        public MicrosoftLocalDbConnectionFactory(string localDbVersion)
        {
        ...
        public MicrosoftLocalDbConnectionFactory(string localDbVersion, string baseConnectionString)
        {
            Check.NotEmpty(localDbVersion, "localDbVersion");
